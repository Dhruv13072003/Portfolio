...
const Details = () => {
  ...
  const award = "Best Web Developer";
  const mainFocus = "Frontend Development";
  const passionateAbout = "Web Development";
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 sm:gap-12 lg:gap-20 p-8 sm:p-12 lg:p-20">
      <div ref={cardRef}>
        <ProfileCard
          name="Dhurv Parmar"
          title={role}
          ...
          innerGradient={"linear-gradient(to bottom, #000000, #000000)"}
        />
      </div>
      <div
        className="flex items-center justify-center mx-auto w-full relative"
        style={{ minHeight: height }}
        ref={canvasRef}
      >
        <FallingText
          text={`I'm a ${role} with ${yearsOfExperience} years of experience. During this journey, I've completed ${projectsCount} projects and achieved ${award} award. My main focus is on ${mainFocus} and I'm passionate about ${passionateAbout}.`}
          highlightWords={[
            "Web",
            yearsOfExperience,
            projectsCount,
        ...
        />
        <div className="hover-text absolute text-white/20 font-bold">
          don't Hover me
        </div>
      </div>
    </div>
